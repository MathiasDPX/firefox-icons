"""
VectorDrawable2Svg
This library converts your VectorDrawable to a Svg
Original author: Alessandro Lucchet
Original link: https://gitlab.com/AlessandroLucchet/VectorDrawable2Svg

Modified to be used as a library
Usage: import this module and call convertVd(vdFilePath) to convert vector drawable files to svg format
"""
